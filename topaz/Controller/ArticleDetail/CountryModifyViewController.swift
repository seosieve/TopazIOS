//
//  ModifyCountryViewController.swift
//  topaz
//
...
protocol ModifyCountryDelegate {
    func modifyCountry(selectedCountryArr: [String], modifyCountryHandler: @escaping () -> ())
}

class CountryModifyViewController: UIViewController {
    ...
    var countryDelegate: ModifyCountryDelegate?
    ...
    @IBAction func completeButtonPressed(_ sender: UIButton) {
        countryDelegate?.modifyCountry(selectedCountryArr: selectedCountryArr) {
            self.dismiss(animated: true, completion: nil)
        }
    }
...
//MARK: - UI Functions
extension CountryModifyViewController {
...
extension CountryModifyViewController: UICollectionViewDelegate, UICollectionViewDataSource {
