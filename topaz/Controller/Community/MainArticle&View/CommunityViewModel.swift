        ...
        db.order(by: "writtenDate", descending: true).getDocuments { querySnapshot, error in
            if let error = error {
                ...
                for document in querySnapshot!.documents {
                    ...
                    let article = Article(auther: auther, writtenDate: writtenDate, strWrittenDate: strWrittenDate, country: country, title: title, mainText: mainText, likes: likes, views: views)
